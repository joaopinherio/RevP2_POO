...
public class App {
    public static void main(String[] args) throws Exception {
         ...
         * ArrayList<Character> vogais = new ArrayList<>(Arrays.asList('a','e',
         * 'i','o','u', 'A', 'E', 'I', 'O', 'U'));
         * 
         * while(!(fila.isEmpty())){
        ...
        /*
         * Conclusao nao rodava pois primeiramente Jogador nao implementava Imposto
         * logo imp nao poderia guardar referencia de Jogador mesmo que fosse inner
         * class
         * e realmente ele nao rodaria sem o override do metodo abstrato
         */

        Imposto imp = new Jogador("Joao", 3) {
            @Override
            ...
            @Override
            public double geraImposto() {
                return 69;
            }
        };
        //questao lista, set
        Queue<Character> fila = new LinkedList<Character> ();
        Character[] filaAux = {'a','a', 'e', 'e', 'o', 'o', 'u'};
        fila.addAll(Arrays.asList(filaAux));
        ...
        System.out.println("numero de letras nao repetidas fila: " + conjunto.size());
